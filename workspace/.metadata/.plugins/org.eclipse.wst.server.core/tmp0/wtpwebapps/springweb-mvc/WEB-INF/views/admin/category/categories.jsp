...
<head>
<meta charset="UTF-8">
<title>Danh mục - Danh mục thể loại</title>
</head>
<body>
									...
									<div class="table-btn-controls">
										<div class="pull-right tableTools-container">
											<div class="dt-buttons btn-overlap btn-group">
												<c:url var="createCategoryURL" value='/quan-tri/danh-muc/them-moi'/>
												<a flag="info"
...
<script type="text/javascript">
	...
	var totalPages = ${categoryDTO.totalPage};
	var currentPage = ${categoryDTO.page};
    $(function () {
