...
<body>
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							<li>
								...
								<a href="${newURL}?page=1&limit=3">Trang chủ</a>
							</li>
								...
								<form:form id="formSubmit" class="form-horizontal" role="form" modelAttribute="newDTO">
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											...
											&nbsp; &nbsp; &nbsp;
											<button class="btn" type="button" onclick="btnCancel()">
												<i class="ace-icon fa fa-check bigger-110"></i>
													Hủy bỏ
											</button>
										</div>
	...
	<script type="text/javascript">
		...
		/* Dưới đây là 2 cách để thực hiện lên button - có thể gọi hàm ngay trên button hoặc cho nó
		1 id sau đó viết hàm cho nó ở dưới này*/
		function btnCancel(){
			window.location.href = "${newURL}?page=1&limit=3";
		}
